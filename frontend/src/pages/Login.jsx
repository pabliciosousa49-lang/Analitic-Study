...
console.log(feedback.status); // 🚀 "Pronto para evoluir"`}
        ...
        {/* ==========================================
            LADO DIREITO: CARD DE LOGIN (Responsivo)
           ========================================== */}
        <div className="flex flex-col justify-center items-center p-6 sm:p-12 lg:p-16 relative">
          ...
          <div className="w-full max-w-[440px] rounded-2xl border border-zinc-800/50 bg-zinc-900/20 p-8 backdrop-blur-md shadow-2xl shadow-black/40">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase tracking-wider">
                <span className="bg-[#0c101b] px-3 text-zinc-500 font-medium rounded-full border border-zinc-800/40 py-0.5">Ou continue com</span>
              </div>
            </div>
